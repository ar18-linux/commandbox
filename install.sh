...
# Dependencies
ar18.pacman.install libappindicator-dev
...
unzip "${temp_dir}/linux-jre64" - d "${cbox_install_dir}"
ar18.script.execute_with_sudo useradd -r -m -U -d "${cbox_install_dir}" -s /bin/false cfbox
